...
sudo apt install python3.9-venv gcc sqlite3 libsqlite3-dev python-dev cython python3-pip cargo
...
sleep 1
python3.9 -m py_client.demos.local_self_play --num_games=10 --config_filepath="server/config/local-covers-config.yaml"
echo "DONE"
