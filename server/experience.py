...
def UpdateLeaderExperience(game_record):
    ...
    if len(leader_experience.last_1k_lead_scores) > 1000:
        ...
        leader_experience.last_1k_lead_scores = leader_experience.last_1k_lead_scores[-1000:]
    leader_experience.lead_score_sum, leader_experience.lead_games_played, leader_experience.lead_score_avg, leader_experience.last_1k_lead_scores = update_game_stats(leader_experience.lead_score_sum, leader_experience.lead_games_played, leader_experience.lead_score_avg, leader_experience.last_1k_lead_scores, game_record.score)
    if len(leader_experience.last_1k_scores) > 1000:
        logger.warning(f"Leader experience entry {game_record.leader.hashed_id} has more than 1000 scores. Truncating.")
        leader_experience.last_1k_scores = leader_experience.last_1k_scores[-1000:]
    leader_experience.total_score_sum, leader_experience.total_games_played, leader_experience.total_score_avg, leader_experience.last_1k_scores = update_game_stats(leader_experience.total_score_sum, leader_experience.total_games_played, leader_experience.total_score_avg, leader_experience.last_1k_scores, game_record.score)

    if (leader_experience.last_lead is None) or (game_record.start_time > leader_experience.last_lead.start_time):
        leader_experience.last_lead = game_record
    if (leader_experience.last_game is None) or (game_record.start_time > leader_experience.last_game.start_time):
...
def UpdateFollowerExperience(game_record):
    ...
    if len(follower_experience.last_1k_follow_scores) > 1000:
        ...
        follower_experience.last_1k_follow_scores = follower_experience.last_1k_follow_scores[-1000:]
    follower_experience.follow_score_sum, follower_experience.follow_games_played, follower_experience.follow_score_avg, follower_experience.last_1k_follow_scores = update_game_stats(follower_experience.follow_score_sum, follower_experience.follow_games_played, follower_experience.follow_score_avg, follower_experience.last_1k_follow_scores, game_record.score)
    if len(follower_experience.last_1k_scores) > 1000:
        logger.warning(f"Leader experience entry {game_record.follower.hashed_id} has more than 1000 scores. Truncating.")
        follower_experience.last_1k_scores = follower_experience.last_1k_scores[-1000:]
    follower_experience.total_score_sum, follower_experience.total_games_played, follower_experience.total_score_avg, follower_experience.last_1k_scores = update_game_stats(follower_experience.total_score_sum, follower_experience.total_games_played, follower_experience.total_score_avg, follower_experience.last_1k_scores, game_record.score)
    
    if (follower_experience.last_follow is None) or (game_record.start_time > follower_experience.last_follow.start_time):
        follower_experience.last_follow = game_record
    if (follower_experience.last_game is None) or (game_record.start_time > follower_experience.last_game.start_time):
