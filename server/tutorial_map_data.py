...
CARDS = [Card(id=0, location=HecsCoord(a=1, r=3, c=3),
    ...
    Card(id=3, location=HecsCoord(a=1, r=2, c=1), rotation_degrees=0, shape=Shape.TRIANGLE
    , color=Color.PINK, count=3, selected=0), Card(id=4,
    location=HecsCoord(a=0, r=1, c=4), rotation_degrees=0, shape=Shape.STAR,
    ...
    color=Color.GREEN, count=1, selected=0),Card(id=8, location=HecsCoord(a=1, r=2, c=9),
    ...
    Card(id=10, location=HecsCoord(a=0, r=2, c=4), rotation_degrees=0,
    ...
    location=HecsCoord(a=0, r=4, c=6), rotation_degrees=0, shape=Shape.DIAMOND,
    color=Color.GREEN, count=1, selected=0), Card(id=16,
    location=HecsCoord(a=1, r=4, c=5), rotation_degrees=0, shape=Shape.TORUS,
    color=Color.BLACK, count=1, selected=0), Card(id=17,
    location=HecsCoord(a=0, r=2, c=6), rotation_degrees=0, shape=Shape.TRIANGLE
    , color=Color.PINK, count=1, selected=0)]
